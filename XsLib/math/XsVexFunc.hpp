...
vex4f::vex4f(float v1, float v2, float v3, float v4) {this->x = v1;this->y = v2;this->z = v3;this->w = v4;};
vex4f::vex4f(float v1, float v2, float v3) {this->x = v1;this->y = v2;this->z = v3;this->w = 0;};
vex4f::vex4f(float v1, float v2) {this->x = v1;this->y = v2;this->z = 0;this->w = 0;};
vex4f::vex4f(float v1) {this->x = v1;this->y = v1;this->z = v1;this->w = v1;};
void vex4f::operator=(const float __vev) {this->x = __vev;this->y = __vev;this->z = __vev;this->w = __vev;};
vex4f vex4f::operator+(const vex4f& __vev) {vex4f __temp;__temp.x = this->x + __vev.x;__temp.y = this->y + __vev.y;__temp.z = this->z + __vev.z;__temp.w = this->w + __vev.w;return __temp;};

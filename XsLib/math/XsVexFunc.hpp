...
float& vex2f::operator[](int v) { return v % 2 == 1 ? y : x; };
float& vex2f::operator[](std::string v) { return std::atoi(v.c_str()) % 2 == 1 ? y : x; };
vex2f vex2f::operator!() { return vex2f(y, x); };
vex2f vex2f::operator%(std::string v) { return vex2f(float(std::rand() % std::atoi(v.c_str())), float(std::rand() % std::atoi(v.c_str()))); };
vex2f vex2f::operator%(int v) { return vex2f(float(std::rand() % v), float(std::rand() % v)); };
vex2f vex2f::operator%(float v) { return vex2f(float(std::rand() % int(v)), float(std::rand() % int(v))); };
vex2f vex2f::operator%(vex2f v) { return vex2f(float(std::rand() % int(v.x)), float(std::rand() % int(v.y))); };
vex2f vex2f::operator%(vex2d v) { return vex2f(float(std::rand() % int(v.x)), float(std::rand() % int(v.y))); };
vex2f vex2f::operator%(vex2i v) { return vex2f(float(std::rand() % int(v.x)), float(std::rand() % int(v.y))); };
vex2f vex2f::operator%(vex3f v) { return vex2f(float(std::rand() % int(v.x)), float(std::rand() % int(v.y))); };
vex2f vex2f::operator%(vex3d v) { return vex2f(float(std::rand() % int(v.x)), float(std::rand() % int(v.y))); };
vex2f vex2f::operator%(vex3i v) { return vex2f(float(std::rand() % int(v.x)), float(std::rand() % int(v.y))); };
vex2f vex2f::operator%(vex4f v) { return vex2f(float(std::rand() % int(v.x)), float(std::rand() % int(v.y))); };
vex2f vex2f::operator%(vex4d v) { return vex2f(float(std::rand() % int(v.x)), float(std::rand() % int(v.y))); };
vex2f vex2f::operator%(vex4i v) { return vex2f(float(std::rand() % int(v.x)), float(std::rand() % int(v.y))); };
void vex2f::operator%=(std::string v) { x = float(std::rand() % std::atoi(v.c_str())); y = float(std::rand() % std::atoi(v.c_str())); };
void vex2f::operator%=(int v) { x = float(std::rand() % v); y = float(std::rand() % v); };
void vex2f::operator%=(float v) { x = float(std::rand() % int(v)); y = float(std::rand() % int(v)); };
void vex2f::operator%=(vex2f v) { x = float(std::rand() % int(v.x)); y = float(std::rand() % int(v.y)); };
void vex2f::operator%=(vex2d v) { x = float(std::rand() % int(v.x)); y = float(std::rand() % int(v.y)); };
void vex2f::operator%=(vex2i v) { x = float(std::rand() % (v.x)); y = float(std::rand() % (v.y)); };
void vex2f::operator%=(vex3f v) { x = float(std::rand() % int(v.x)); y = float(std::rand() % int(v.y)); };
void vex2f::operator%=(vex3d v) { x = float(std::rand() % int(v.x)); y = float(std::rand() % int(v.y)); };
void vex2f::operator%=(vex3i v) { x = float(std::rand() % (v.x)); y = float(std::rand() % (v.y)); };
void vex2f::operator%=(vex4f v) { x = float(std::rand() % int(v.x)); y = float(std::rand() % int(v.y)); };
void vex2f::operator%=(vex4d v) { x = float(std::rand() % int(v.x)); y = float(std::rand() % int(v.y)); };
void vex2f::operator%=(vex4i v) { x = float(std::rand() % (v.x)); y = float(std::rand() % (v.y)); };
vex2f vex2f::operator|(vex2f v) { return randomb() == 0 ? v : vex2f(x, y); };
vex2f vex2f::operator|(vex2d v) { return randomb() == 0 ? vex2f(v.x, v.y) : vex2f(x, y); };
vex2f vex2f::operator|(vex2i v) { return randomb() == 0 ? vex2f(v.x, v.y) : vex2f(x, y); };
vex2f vex2f::operator|(vex3f v) { return randomb() == 0 ? vex2f(v.x, v.y) : vex2f(x, y); };
vex2f vex2f::operator|(vex3d v) { return randomb() == 0 ? vex2f(v.x, v.y) : vex2f(x, y); };
vex2f vex2f::operator|(vex3i v) { return randomb() == 0 ? vex2f(v.x, v.y) : vex2f(x, y); };
vex2f vex2f::operator|(vex4f v) { return randomb() == 0 ? vex2f(v.x, v.y) : vex2f(x, y); };
vex2f vex2f::operator|(vex4d v) { return randomb() == 0 ? vex2f(v.x, v.y) : vex2f(x, y); };
vex2f vex2f::operator|(vex4i v) { return randomb() == 0 ? vex2f(v.x, v.y) : vex2f(x, y); };
void vex2f::operator|=(vex2f v) { x = randomb() == 0 ? v.x : x;		y = randomb() == 0 ? v.y : y; };
void vex2f::operator|=(vex2d v) { x = randomb() == 0 ? float(v.x) : x; y = randomb() == 0 ? float(v.y) : y; };
void vex2f::operator|=(vex2i v) { x = randomb() == 0 ? float(v.x) : x; y = randomb() == 0 ? float(v.y) : y; };
void vex2f::operator|=(vex3f v) { x = randomb() == 0 ? v.x : x;		y = randomb() == 0 ? v.y : y; };
void vex2f::operator|=(vex3d v) { x = randomb() == 0 ? float(v.x) : x; y = randomb() == 0 ? float(v.y) : y; };
void vex2f::operator|=(vex3i v) { x = randomb() == 0 ? float(v.x) : x; y = randomb() == 0 ? float(v.y) : y; };
void vex2f::operator|=(vex4f v) { x = randomb() == 0 ? v.x : x;		y = randomb() == 0 ? v.y : y; };
void vex2f::operator|=(vex4d v) { x = randomb() == 0 ? float(v.x) : x; y = randomb() == 0 ? float(v.y) : y; };
void vex2f::operator|=(vex4i v) { x = randomb() == 0 ? float(v.x) : x; y = randomb() == 0 ? float(v.y) : y; };

double& vex2d::operator[](int v) { return v % 2 == 1 ? y : x; };
double& vex2d::operator[](std::string v) { return std::atoi(v.c_str()) % 2 == 1 ? y : x; };
vex2d vex2d::operator!() { return vex2f(y, x); };
vex2d vex2d::operator%(std::string v) { return vex2f(double(std::rand() % std::atoi(v.c_str())), double(std::rand() % std::atoi(v.c_str()))); };
vex2d vex2d::operator%(int v) { return vex2f(double(std::rand() % v), double(std::rand() % v)); };
vex2d vex2d::operator%(double v) { return vex2f(double(std::rand() % int(v)), double(std::rand() % int(v))); };
vex2d vex2d::operator%(vex2f v) { return vex2f(double(std::rand() % int(v.x)), double(std::rand() % int(v.y))); };
vex2d vex2d::operator%(vex2d v) { return vex2f(double(std::rand() % int(v.x)), double(std::rand() % int(v.y))); };
vex2d vex2d::operator%(vex2i v) { return vex2f(double(std::rand() % int(v.x)), double(std::rand() % int(v.y))); };
vex2d vex2d::operator%(vex3f v) { return vex2f(double(std::rand() % int(v.x)), double(std::rand() % int(v.y))); };
vex2d vex2d::operator%(vex3d v) { return vex2f(double(std::rand() % int(v.x)), double(std::rand() % int(v.y))); };
vex2d vex2d::operator%(vex3i v) { return vex2f(double(std::rand() % int(v.x)), double(std::rand() % int(v.y))); };
vex2d vex2d::operator%(vex4f v) { return vex2f(double(std::rand() % int(v.x)), double(std::rand() % int(v.y))); };
vex2d vex2d::operator%(vex4d v) { return vex2f(double(std::rand() % int(v.x)), double(std::rand() % int(v.y))); };
vex2d vex2d::operator%(vex4i v) { return vex2f(double(std::rand() % int(v.x)), double(std::rand() % int(v.y))); };
void vex2d::operator%=(std::string v) { x = double(std::rand() % std::atoi(v.c_str())); y = double(std::rand() % std::atoi(v.c_str())); };
void vex2d::operator%=(int v) { x = double(std::rand() % v); y = double(std::rand() % v); };
void vex2d::operator%=(double v) { x = double(std::rand() % int(v)); y = double(std::rand() % int(v)); };
void vex2d::operator%=(vex2f v) { x = double(std::rand() % int(v.x)); y = double(std::rand() % int(v.y)); };
void vex2d::operator%=(vex2d v) { x = double(std::rand() % int(v.x)); y = double(std::rand() % int(v.y)); };
void vex2d::operator%=(vex2i v) { x = double(std::rand() % (v.x)); y = double(std::rand() % (v.y)); };
void vex2d::operator%=(vex3f v) { x = double(std::rand() % int(v.x)); y = double(std::rand() % int(v.y)); };
void vex2d::operator%=(vex3d v) { x = double(std::rand() % int(v.x)); y = double(std::rand() % int(v.y)); };
void vex2d::operator%=(vex3i v) { x = double(std::rand() % (v.x)); y = double(std::rand() % (v.y)); };
void vex2d::operator%=(vex4f v) { x = double(std::rand() % int(v.x)); y = double(std::rand() % int(v.y)); };
void vex2d::operator%=(vex4d v) { x = double(std::rand() % int(v.x)); y = double(std::rand() % int(v.y)); };
void vex2d::operator%=(vex4i v) { x = double(std::rand() % (v.x)); y = double(std::rand() % (v.y)); };
vex2d vex2d::operator|(vex2d v) { return randomb() == 0 ? v : vex2d(x, y); };
vex2d vex2d::operator|(vex2f v) { return randomb() == 0 ? vex2d(v.x, v.y) : vex2d(x, y); };
vex2d vex2d::operator|(vex2i v) { return randomb() == 0 ? vex2d(v.x, v.y) : vex2d(x, y); };
vex2d vex2d::operator|(vex3f v) { return randomb() == 0 ? vex2d(v.x, v.y) : vex2d(x, y); };
vex2d vex2d::operator|(vex3d v) { return randomb() == 0 ? vex2d(v.x, v.y) : vex2d(x, y); };
vex2d vex2d::operator|(vex3i v) { return randomb() == 0 ? vex2d(v.x, v.y) : vex2d(x, y); };
vex2d vex2d::operator|(vex4f v) { return randomb() == 0 ? vex2d(v.x, v.y) : vex2d(x, y); };
vex2d vex2d::operator|(vex4d v) { return randomb() == 0 ? vex2d(v.x, v.y) : vex2d(x, y); };
vex2d vex2d::operator|(vex4i v) { return randomb() == 0 ? vex2d(v.x, v.y) : vex2d(x, y); };
void vex2d::operator|=(vex2d v) { x = randomb() == 0 ? v.x : x;		y = randomb() == 0 ? v.y : y; };
void vex2d::operator|=(vex2f v) { x = randomb() == 0 ? double(v.x) : x; y = randomb() == 0 ? double(v.y) : y; };
void vex2d::operator|=(vex2i v) { x = randomb() == 0 ? double(v.x) : x; y = randomb() == 0 ? double(v.y) : y; };
void vex2d::operator|=(vex3d v) { x = randomb() == 0 ? v.x : x;		y = randomb() == 0 ? v.y : y; };
void vex2d::operator|=(vex3f v) { x = randomb() == 0 ? double(v.x) : x; y = randomb() == 0 ? double(v.y) : y; };
void vex2d::operator|=(vex3i v) { x = randomb() == 0 ? double(v.x) : x; y = randomb() == 0 ? double(v.y) : y; };
void vex2d::operator|=(vex4d v) { x = randomb() == 0 ? v.x : x;		y = randomb() == 0 ? v.y : y; };
void vex2d::operator|=(vex4f v) { x = randomb() == 0 ? double(v.x) : x; y = randomb() == 0 ? double(v.y) : y; };
void vex2d::operator|=(vex4i v) { x = randomb() == 0 ? double(v.x) : x; y = randomb() == 0 ? double(v.y) : y; };

int& vex2i::operator[](int v) { return v % 2 == 1 ? y : x; };
int& vex2i::operator[](std::string v) { return std::atoi(v.c_str()) % 2 == 1 ? y : x; };
vex2i vex2i::operator!() { return vex2f(y, x); };
vex2i vex2i::operator%(std::string v) { return vex2f(int(std::rand() % std::atoi(v.c_str())), int(std::rand() % std::atoi(v.c_str()))); };
vex2i vex2i::operator%(int v) { return vex2f(int(std::rand() % v), int(std::rand() % v)); };
vex2i vex2i::operator%(vex2f v) { return vex2f(int(std::rand() % int(v.x)), int(std::rand() % int(v.y))); };
vex2i vex2i::operator%(vex2d v) { return vex2f(int(std::rand() % int(v.x)), int(std::rand() % int(v.y))); };
vex2i vex2i::operator%(vex2i v) { return vex2f(int(std::rand() % int(v.x)), int(std::rand() % int(v.y))); };
vex2i vex2i::operator%(vex3f v) { return vex2f(int(std::rand() % int(v.x)), int(std::rand() % int(v.y))); };
vex2i vex2i::operator%(vex3d v) { return vex2f(int(std::rand() % int(v.x)), int(std::rand() % int(v.y))); };
vex2i vex2i::operator%(vex3i v) { return vex2f(int(std::rand() % int(v.x)), int(std::rand() % int(v.y))); };
vex2i vex2i::operator%(vex4f v) { return vex2f(int(std::rand() % int(v.x)), int(std::rand() % int(v.y))); };
vex2i vex2i::operator%(vex4d v) { return vex2f(int(std::rand() % int(v.x)), int(std::rand() % int(v.y))); };
vex2i vex2i::operator%(vex4i v) { return vex2f(int(std::rand() % int(v.x)), int(std::rand() % int(v.y))); };
void vex2i::operator%=(std::string v) { x = int(std::rand() % std::atoi(v.c_str())); y = int(std::rand() % std::atoi(v.c_str())); };
void vex2i::operator%=(int v) { x = int(std::rand() % v); y = int(std::rand() % v); };
void vex2i::operator%=(vex2f v) { x = int(std::rand() % int(v.x)); y = int(std::rand() % int(v.y)); };
void vex2i::operator%=(vex2d v) { x = int(std::rand() % int(v.x)); y = int(std::rand() % int(v.y)); };
void vex2i::operator%=(vex2i v) { x = int(std::rand() % (v.x)); y = int(std::rand() % (v.y)); };
void vex2i::operator%=(vex3f v) { x = int(std::rand() % int(v.x)); y = int(std::rand() % int(v.y)); };
void vex2i::operator%=(vex3d v) { x = int(std::rand() % int(v.x)); y = int(std::rand() % int(v.y)); };
void vex2i::operator%=(vex3i v) { x = int(std::rand() % (v.x)); y = int(std::rand() % (v.y)); };
void vex2i::operator%=(vex4f v) { x = int(std::rand() % int(v.x)); y = int(std::rand() % int(v.y)); };
void vex2i::operator%=(vex4d v) { x = int(std::rand() % int(v.x)); y = int(std::rand() % int(v.y)); };
void vex2i::operator%=(vex4i v) { x = int(std::rand() % (v.x)); y = int(std::rand() % (v.y)); };
vex2i vex2i::operator|(vex2i v) { return randomb() == 0 ? v : vex2i(x, y); };
vex2i vex2i::operator|(vex2d v) { return randomb() == 0 ? vex2i(v.x, v.y) : vex2i(x, y); };
vex2i vex2i::operator|(vex2f v) { return randomb() == 0 ? vex2i(v.x, v.y) : vex2i(x, y); };
vex2i vex2i::operator|(vex3f v) { return randomb() == 0 ? vex2i(v.x, v.y) : vex2i(x, y); };
vex2i vex2i::operator|(vex3d v) { return randomb() == 0 ? vex2i(v.x, v.y) : vex2i(x, y); };
vex2i vex2i::operator|(vex3i v) { return randomb() == 0 ? vex2i(v.x, v.y) : vex2i(x, y); };
vex2i vex2i::operator|(vex4f v) { return randomb() == 0 ? vex2i(v.x, v.y) : vex2i(x, y); };
vex2i vex2i::operator|(vex4d v) { return randomb() == 0 ? vex2i(v.x, v.y) : vex2i(x, y); };
vex2i vex2i::operator|(vex4i v) { return randomb() == 0 ? vex2i(v.x, v.y) : vex2i(x, y); };
void vex2i::operator|=(vex2i v) { x = randomb() == 0 ? v.x : x;		y = randomb() == 0 ? v.y : y; };
void vex2i::operator|=(vex2d v) { x = randomb() == 0 ? int(v.x) : x; y = randomb() == 0 ? int(v.y) : y; };
void vex2i::operator|=(vex2f v) { x = randomb() == 0 ? int(v.x) : x; y = randomb() == 0 ? int(v.y) : y; };
void vex2i::operator|=(vex3i v) { x = randomb() == 0 ? v.x : x;		y = randomb() == 0 ? v.y : y; };
void vex2i::operator|=(vex3d v) { x = randomb() == 0 ? int(v.x) : x; y = randomb() == 0 ? int(v.y) : y; };
void vex2i::operator|=(vex3f v) { x = randomb() == 0 ? int(v.x) : x; y = randomb() == 0 ? int(v.y) : y; };
void vex2i::operator|=(vex4i v) { x = randomb() == 0 ? v.x : x;		y = randomb() == 0 ? v.y : y; };
void vex2i::operator|=(vex4d v) { x = randomb() == 0 ? int(v.x) : x; y = randomb() == 0 ? int(v.y) : y; };
void vex2i::operator|=(vex4f v) { x = randomb() == 0 ? int(v.x) : x; y = randomb() == 0 ? int(v.y) : y; };

float& vex3f::operator[](int v) { return fmod(v, 3) == 0 ? x : fmod(v, 3) == 1 ? y : z; };
float& vex3f::operator[](std::string v) { return fmod(std::atoi(v.c_str()), 3) == 0 ? x : fmod(std::atoi(v.c_str()), 3) == 1 ? y : z; };
vex3f vex3f::operator!() { return vex3f(z, y, x); };
vex3f vex3f::operator%(std::string v) { return vex3f(float(std::rand() % std::atoi(v.c_str())), float(std::rand() % std::atoi(v.c_str())), float(std::rand() % std::atoi(v.c_str()))); };
vex3f vex3f::operator%(int v) { return vex3f(float(std::rand() % v), float(std::rand() % v), float(std::rand() % v)); };
vex3f vex3f::operator%(float v) { return vex3f(float(std::rand() % int(v)), float(std::rand() % int(v)), float(std::rand() % int(v))); };
vex3f vex3f::operator%(vex2f v) { return vex3f(float(std::rand() % int(v.x)), float(std::rand() % int(v.y))); };
vex3f vex3f::operator%(vex2d v) { return vex3f(float(std::rand() % int(v.x)), float(std::rand() % int(v.y))); };
vex3f vex3f::operator%(vex2i v) { return vex3f(float(std::rand() % int(v.x)), float(std::rand() % int(v.y))); };
vex3f vex3f::operator%(vex3f v) { return vex3f(float(std::rand() % int(v.x)), float(std::rand() % int(v.y)), float(std::rand() % int(v.z))); };
vex3f vex3f::operator%(vex3d v) { return vex3f(float(std::rand() % int(v.x)), float(std::rand() % int(v.y)), float(std::rand() % int(v.z))); };
vex3f vex3f::operator%(vex3i v) { return vex3f(float(std::rand() % int(v.x)), float(std::rand() % int(v.y)), float(std::rand() % int(v.z))); };
vex3f vex3f::operator%(vex4f v) { return vex3f(float(std::rand() % int(v.x)), float(std::rand() % int(v.y)), float(std::rand() % int(v.z))); };
vex3f vex3f::operator%(vex4d v) { return vex3f(float(std::rand() % int(v.x)), float(std::rand() % int(v.y)), float(std::rand() % int(v.z))); };
vex3f vex3f::operator%(vex4i v) { return vex3f(float(std::rand() % int(v.x)), float(std::rand() % int(v.y)), float(std::rand() % int(v.z))); };
void vex3f::operator%=(std::string v) { x = float(std::rand() % std::atoi(v.c_str())); y = float(std::rand() % std::atoi(v.c_str())); z = float(std::rand() % std::atoi(v.c_str())); };
void vex3f::operator%=(int v) { x = float(std::rand() % v); y = float(std::rand() % v); z = float(std::rand() % v); };
void vex3f::operator%=(float v) { x = float(std::rand() % int(v)); y = float(std::rand() % int(v)); z = float(std::rand() % int(v)); };
void vex3f::operator%=(vex2f v) { x = float(std::rand() % int(v.x)); y = float(std::rand() % int(v.y)); };
void vex3f::operator%=(vex2d v) { x = float(std::rand() % int(v.x)); y = float(std::rand() % int(v.y)); };
void vex3f::operator%=(vex2i v) { x = float(std::rand() % (v.x)); y = float(std::rand() % (v.y)); };
void vex3f::operator%=(vex3f v) { x = float(std::rand() % int(v.x)); y = float(std::rand() % int(v.y)); z = float(std::rand() % int(v.z)); };
void vex3f::operator%=(vex3d v) { x = float(std::rand() % int(v.x)); y = float(std::rand() % int(v.y)); z = float(std::rand() % int(v.z)); };
void vex3f::operator%=(vex3i v) { x = float(std::rand() % (v.x)); y = float(std::rand() % (v.y)); z = float(std::rand() % int(v.z)); };
void vex3f::operator%=(vex4f v) { x = float(std::rand() % int(v.x)); y = float(std::rand() % int(v.y)); z = float(std::rand() % int(v.z)); };
void vex3f::operator%=(vex4d v) { x = float(std::rand() % int(v.x)); y = float(std::rand() % int(v.y)); z = float(std::rand() % int(v.z)); };
void vex3f::operator%=(vex4i v) { x = float(std::rand() % (v.x)); y = float(std::rand() % (v.y)); z = float(std::rand() % (v.z)); };
vex3f vex3f::operator|(vex3f v) { return randomb() == 0 ? v : vex3f(x, y, z); };
vex3f vex3f::operator|(vex2d v) { return randomb() == 0 ? vex3f(v) : vex3f(x, y, z); };
vex3f vex3f::operator|(vex2i v) { return randomb() == 0 ? vex3f(v) : vex3f(x, y, z); };
vex3f vex3f::operator|(vex2f v) { return randomb() == 0 ? vex3f(v) : vex3f(x, y, z); };
vex3f vex3f::operator|(vex3d v) { return randomb() == 0 ? vex3f(v.x, v.y, v.z) : vex3f(x, y, z); };
vex3f vex3f::operator|(vex3i v) { return randomb() == 0 ? vex3f(v.x, v.y, v.z) : vex3f(x, y, z); };
vex3f vex3f::operator|(vex4f v) { return randomb() == 0 ? vex3f(v.x, v.y, v.z) : vex3f(x, y, z); };
vex3f vex3f::operator|(vex4d v) { return randomb() == 0 ? vex3f(v.x, v.y, v.z) : vex3f(x, y, z); };
vex3f vex3f::operator|(vex4i v) { return randomb() == 0 ? vex3f(v.x, v.y, v.z) : vex3f(x, y, z); };
void vex3f::operator|=(vex2f v) { x = randomb() == 0 ? v.x : x;		y = randomb() == 0 ? v.y : y; };
void vex3f::operator|=(vex2d v) { x = randomb() == 0 ? float(v.x) : x; y = randomb() == 0 ? float(v.y) : y; };
void vex3f::operator|=(vex2i v) { x = randomb() == 0 ? float(v.x) : x; y = randomb() == 0 ? float(v.y) : y; };
void vex3f::operator|=(vex3f v) { x = randomb() == 0 ? v.x : x;		y = randomb() == 0 ? v.y : y; z = randomb() == 0 ? v.z : z; };
void vex3f::operator|=(vex3d v) { x = randomb() == 0 ? float(v.x) : x; y = randomb() == 0 ? float(v.y) : y; z = randomb() == 0 ? float(v.z) : z; };
void vex3f::operator|=(vex3i v) { x = randomb() == 0 ? float(v.x) : x; y = randomb() == 0 ? float(v.y) : y; z = randomb() == 0 ? float(v.z) : z; };
void vex3f::operator|=(vex4f v) { x = randomb() == 0 ? v.x : x;		y = randomb() == 0 ? v.y : y; z = randomb() == 0 ? v.z : z; };
void vex3f::operator|=(vex4d v) { x = randomb() == 0 ? float(v.x) : x; y = randomb() == 0 ? float(v.y) : y; z = randomb() == 0 ? float(v.z) : z; };
void vex3f::operator|=(vex4i v) { x = randomb() == 0 ? float(v.x) : x; y = randomb() == 0 ? float(v.y) : y; z = randomb() == 0 ? float(v.z) : z; };

double& vex3d::operator[](int v) { return fmod(v, 3) == 0 ? x : fmod(v, 3) == 1 ? y : z; };
double& vex3d::operator[](std::string v) { return fmod(std::atoi(v.c_str()), 3) == 0 ? x : fmod(std::atoi(v.c_str()), 3) == 1 ? y : z; };
vex3d vex3d::operator!() { return vex3d(z, y, x); };
vex3d vex3d::operator%(std::string v) { return vex3d(double(std::rand() % std::atoi(v.c_str())), double(std::rand() % std::atoi(v.c_str())), double(std::rand() % std::atoi(v.c_str()))); };
vex3d vex3d::operator%(int v) { return vex3d(double(std::rand() % v), double(std::rand() % v), double(std::rand() % v)); };
vex3d vex3d::operator%(double v) { return vex3d(double(std::rand() % int(v)), double(std::rand() % int(v)), double(std::rand() % int(v))); };
vex3d vex3d::operator%(vex2f v) { return vex3d(double(std::rand() % int(v.x)), double(std::rand() % int(v.y))); };
vex3d vex3d::operator%(vex2d v) { return vex3d(double(std::rand() % int(v.x)), double(std::rand() % int(v.y))); };
vex3d vex3d::operator%(vex2i v) { return vex3d(double(std::rand() % int(v.x)), double(std::rand() % int(v.y))); };
vex3d vex3d::operator%(vex3f v) { return vex3d(double(std::rand() % int(v.x)), double(std::rand() % int(v.y)), double(std::rand() % int(v.z))); };
vex3d vex3d::operator%(vex3d v) { return vex3d(double(std::rand() % int(v.x)), double(std::rand() % int(v.y)), double(std::rand() % int(v.z))); };
vex3d vex3d::operator%(vex3i v) { return vex3d(double(std::rand() % int(v.x)), double(std::rand() % int(v.y)), double(std::rand() % int(v.z))); };
vex3d vex3d::operator%(vex4f v) { return vex3d(double(std::rand() % int(v.x)), double(std::rand() % int(v.y)), double(std::rand() % int(v.z))); };
vex3d vex3d::operator%(vex4d v) { return vex3d(double(std::rand() % int(v.x)), double(std::rand() % int(v.y)), double(std::rand() % int(v.z))); };
vex3d vex3d::operator%(vex4i v) { return vex3d(double(std::rand() % int(v.x)), double(std::rand() % int(v.y)), double(std::rand() % int(v.z))); };
void vex3d::operator%=(std::string v) { x = double(std::rand() % std::atoi(v.c_str())); y = double(std::rand() % std::atoi(v.c_str())); z = double(std::rand() % std::atoi(v.c_str())); };
void vex3d::operator%=(int v) { x = double(std::rand() % v); y = double(std::rand() % v); z = double(std::rand() % v); };
void vex3d::operator%=(double v) { x = double(std::rand() % int(v)); y = double(std::rand() % int(v)); z = double(std::rand() % int(v)); };
void vex3d::operator%=(vex2f v) { x = double(std::rand() % int(v.x)); y = double(std::rand() % int(v.y)); };
void vex3d::operator%=(vex2d v) { x = double(std::rand() % int(v.x)); y = double(std::rand() % int(v.y)); };
void vex3d::operator%=(vex2i v) { x = double(std::rand() % (v.x)); y = double(std::rand() % (v.y)); };
void vex3d::operator%=(vex3f v) { x = double(std::rand() % int(v.x)); y = double(std::rand() % int(v.y)); z = double(std::rand() % int(v.z)); };
void vex3d::operator%=(vex3d v) { x = double(std::rand() % int(v.x)); y = double(std::rand() % int(v.y)); z = double(std::rand() % int(v.z)); };
void vex3d::operator%=(vex3i v) { x = double(std::rand() % (v.x)); y = double(std::rand() % (v.y)); z = double(std::rand() % int(v.z)); };
void vex3d::operator%=(vex4f v) { x = double(std::rand() % int(v.x)); y = double(std::rand() % int(v.y)); z = double(std::rand() % int(v.z)); };
void vex3d::operator%=(vex4d v) { x = double(std::rand() % int(v.x)); y = double(std::rand() % int(v.y)); z = double(std::rand() % int(v.z)); };
void vex3d::operator%=(vex4i v) { x = double(std::rand() % (v.x)); y = double(std::rand() % (v.y)); z = double(std::rand() % (v.z)); };
vex3d vex3d::operator|(vex3d v) { return randomb() == 0 ? v : vex3d(x, y, z); };
vex3d vex3d::operator|(vex2d v) { return randomb() == 0 ? vex3f(v) : vex3f(x, y, z); };
vex3d vex3d::operator|(vex2i v) { return randomb() == 0 ? vex3f(v) : vex3f(x, y, z); };
vex3d vex3d::operator|(vex2f v) { return randomb() == 0 ? vex3f(v) : vex3f(x, y, z); };
vex3d vex3d::operator|(vex3f v) { return randomb() == 0 ? vex3f(v.x, v.y, v.z) : vex3f(x, y, z); };
vex3d vex3d::operator|(vex3i v) { return randomb() == 0 ? vex3f(v.x, v.y, v.z) : vex3f(x, y, z); };
vex3d vex3d::operator|(vex4f v) { return randomb() == 0 ? vex3f(v.x, v.y, v.z) : vex3f(x, y, z); };
vex3d vex3d::operator|(vex4d v) { return randomb() == 0 ? vex3f(v.x, v.y, v.z) : vex3f(x, y, z); };
vex3d vex3d::operator|(vex4i v) { return randomb() == 0 ? vex3f(v.x, v.y, v.z) : vex3f(x, y, z); };
void vex3d::operator|=(vex2d v) { x = randomb() == 0 ? v.x : x;		y = randomb() == 0 ? v.y : y; };
void vex3d::operator|=(vex2f v) { x = randomb() == 0 ? double(v.x) : x; y = randomb() == 0 ? double(v.y) : y; };
void vex3d::operator|=(vex2i v) { x = randomb() == 0 ? double(v.x) : x; y = randomb() == 0 ? double(v.y) : y; };
void vex3d::operator|=(vex3d v) { x = randomb() == 0 ? v.x : x;		y = randomb() == 0 ? v.y : y; z = randomb() == 0 ? v.z : z; };
void vex3d::operator|=(vex3f v) { x = randomb() == 0 ? double(v.x) : x; y = randomb() == 0 ? double(v.y) : y; z = randomb() == 0 ? double(v.z) : z; };
void vex3d::operator|=(vex3i v) { x = randomb() == 0 ? double(v.x) : x; y = randomb() == 0 ? double(v.y) : y; z = randomb() == 0 ? double(v.z) : z; };
void vex3d::operator|=(vex4d v) { x = randomb() == 0 ? v.x : x;		y = randomb() == 0 ? v.y : y; z = randomb() == 0 ? v.z : z; };
void vex3d::operator|=(vex4f v) { x = randomb() == 0 ? double(v.x) : x; y = randomb() == 0 ? double(v.y) : y; z = randomb() == 0 ? double(v.z) : z; };
void vex3d::operator|=(vex4i v) { x = randomb() == 0 ? double(v.x) : x; y = randomb() == 0 ? double(v.y) : y; z = randomb() == 0 ? double(v.z) : z; };

int& vex3i::operator[](int v) { return fmod(v, 3) == 0 ? x : fmod(v, 3) == 1 ? y : z; };
int& vex3i::operator[](std::string v) { return fmod(std::atoi(v.c_str()), 3) == 0 ? x : fmod(std::atoi(v.c_str()), 3) == 1 ? y : z; };
vex3i vex3i::operator!() { return vex3i(z, y, x); };
vex3i vex3i::operator%(std::string v) { return vex3i(int(std::rand() % std::atoi(v.c_str())), int(std::rand() % std::atoi(v.c_str())), int(std::rand() % std::atoi(v.c_str()))); };
vex3i vex3i::operator%(int v) { return vex3i(int(std::rand() % v), int(std::rand() % v), int(std::rand() % v)); };
vex3i vex3i::operator%(vex2f v) { return vex3i(int(std::rand() % int(v.x)), int(std::rand() % int(v.y))); };
vex3i vex3i::operator%(vex2d v) { return vex3i(int(std::rand() % int(v.x)), int(std::rand() % int(v.y))); };
vex3i vex3i::operator%(vex2i v) { return vex3i(int(std::rand() % int(v.x)), int(std::rand() % int(v.y))); };
vex3i vex3i::operator%(vex3f v) { return vex3i(int(std::rand() % int(v.x)), int(std::rand() % int(v.y)), int(std::rand() % int(v.z))); };
vex3i vex3i::operator%(vex3d v) { return vex3i(int(std::rand() % int(v.x)), int(std::rand() % int(v.y)), int(std::rand() % int(v.z))); };
vex3i vex3i::operator%(vex3i v) { return vex3i(int(std::rand() % int(v.x)), int(std::rand() % int(v.y)), int(std::rand() % int(v.z))); };
vex3i vex3i::operator%(vex4f v) { return vex3i(int(std::rand() % int(v.x)), int(std::rand() % int(v.y)), int(std::rand() % int(v.z))); };
vex3i vex3i::operator%(vex4d v) { return vex3i(int(std::rand() % int(v.x)), int(std::rand() % int(v.y)), int(std::rand() % int(v.z))); };
vex3i vex3i::operator%(vex4i v) { return vex3i(int(std::rand() % int(v.x)), int(std::rand() % int(v.y)), int(std::rand() % int(v.z))); };
void vex3i::operator%=(std::string v) { x = int(std::rand() % std::atoi(v.c_str())); y = int(std::rand() % std::atoi(v.c_str())); z = int(std::rand() % std::atoi(v.c_str())); };
void vex3i::operator%=(int v) { x = int(std::rand() % v); y = int(std::rand() % v); z = int(std::rand() % v); };
void vex3i::operator%=(vex2f v) { x = int(std::rand() % int(v.x)); y = int(std::rand() % int(v.y)); };
void vex3i::operator%=(vex2d v) { x = int(std::rand() % int(v.x)); y = int(std::rand() % int(v.y)); };
void vex3i::operator%=(vex2i v) { x = int(std::rand() % (v.x)); y = int(std::rand() % (v.y)); };
void vex3i::operator%=(vex3f v) { x = int(std::rand() % int(v.x)); y = int(std::rand() % int(v.y)); z = int(std::rand() % int(v.z)); };
void vex3i::operator%=(vex3d v) { x = int(std::rand() % int(v.x)); y = int(std::rand() % int(v.y)); z = int(std::rand() % int(v.z)); };
void vex3i::operator%=(vex3i v) { x = int(std::rand() % (v.x)); y = int(std::rand() % (v.y)); z = int(std::rand() % int(v.z)); };
void vex3i::operator%=(vex4f v) { x = int(std::rand() % int(v.x)); y = int(std::rand() % int(v.y)); z = int(std::rand() % int(v.z)); };
void vex3i::operator%=(vex4d v) { x = int(std::rand() % int(v.x)); y = int(std::rand() % int(v.y)); z = int(std::rand() % int(v.z)); };
void vex3i::operator%=(vex4i v) { x = int(std::rand() % (v.x)); y = int(std::rand() % (v.y)); z = int(std::rand() % (v.z)); };
vex3i vex3i::operator|(vex3i v) { return randomb() == 0 ? v : vex3i(x, y, z); };
vex3i vex3i::operator|(vex2d v) { return randomb() == 0 ? vex3i(v) : vex3i(x, y, z); };
vex3i vex3i::operator|(vex2i v) { return randomb() == 0 ? vex3i(v) : vex3i(x, y, z); };
vex3i vex3i::operator|(vex2f v) { return randomb() == 0 ? vex3i(v) : vex3i(x, y, z); };
vex3i vex3i::operator|(vex3f v) { return randomb() == 0 ? vex3i(v.x, v.y, v.z) : vex3i(x, y, z); };
vex3i vex3i::operator|(vex3d v) { return randomb() == 0 ? vex3i(v.x, v.y, v.z) : vex3i(x, y, z); };
vex3i vex3i::operator|(vex4f v) { return randomb() == 0 ? vex3i(v.x, v.y, v.z) : vex3i(x, y, z); };
vex3i vex3i::operator|(vex4d v) { return randomb() == 0 ? vex3i(v.x, v.y, v.z) : vex3i(x, y, z); };
vex3i vex3i::operator|(vex4i v) { return randomb() == 0 ? vex3i(v.x, v.y, v.z) : vex3i(x, y, z); };
void vex3i::operator|=(vex2i v) { x = randomb() == 0 ? v.x : x;		y = randomb() == 0 ? v.y : y; };
void vex3i::operator|=(vex2f v) { x = randomb() == 0 ? int(v.x) : x; y = randomb() == 0 ? int(v.y) : y; };
void vex3i::operator|=(vex2d v) { x = randomb() == 0 ? int(v.x) : x; y = randomb() == 0 ? int(v.y) : y; };
void vex3i::operator|=(vex3i v) { x = randomb() == 0 ? v.x : x;		y = randomb() == 0 ? v.y : y; z = randomb() == 0 ? v.z : z; };
void vex3i::operator|=(vex3f v) { x = randomb() == 0 ? int(v.x) : x; y = randomb() == 0 ? int(v.y) : y; z = randomb() == 0 ? int(v.z) : z; };
void vex3i::operator|=(vex3d v) { x = randomb() == 0 ? int(v.x) : x; y = randomb() == 0 ? int(v.y) : y; z = randomb() == 0 ? int(v.z) : z; };
void vex3i::operator|=(vex4i v) { x = randomb() == 0 ? v.x : x;		y = randomb() == 0 ? v.y : y; z = randomb() == 0 ? v.z : z; };
void vex3i::operator|=(vex4f v) { x = randomb() == 0 ? int(v.x) : x; y = randomb() == 0 ? int(v.y) : y; z = randomb() == 0 ? int(v.z) : z; };
void vex3i::operator|=(vex4d v) { x = randomb() == 0 ? int(v.x) : x; y = randomb() == 0 ? int(v.y) : y; z = randomb() == 0 ? int(v.z) : z; };

float& vex4f::operator[](int v) { return fmod(v, 4) == 0 ? x : fmod(v, 4) == 1 ? y : fmod(v, 4) == 2 ? z : w; };
float& vex4f::operator[](std::string v) { return fmod(std::atoi(v.c_str()), 4) == 0 ? x : fmod(std::atoi(v.c_str()), 4) == 1 ? y : fmod(std::atoi(v.c_str()), 4) == 2 ? z : w; };
vex4f vex4f::operator!() { return vex4f(w, z, y, x); };
vex4f vex4f::operator%(std::string v) { return vex4f(float(std::rand() % std::atoi(v.c_str())), float(std::rand() % std::atoi(v.c_str())), float(std::rand() % std::atoi(v.c_str()))); };
vex4f vex4f::operator%(int v) { return vex4f(float(std::rand() % v), float(std::rand() % v), float(std::rand() % v), float(std::rand() % v)); };
vex4f vex4f::operator%(float v) { return vex4f(float(std::rand() % int(v)), float(std::rand() % int(v)), float(std::rand() % int(v)), float(std::rand() % int(v))); };
vex4f vex4f::operator%(vex2f v) { return vex4f(float(std::rand() % int(v.x)), float(std::rand() % int(v.y))); };
vex4f vex4f::operator%(vex2d v) { return vex4f(float(std::rand() % int(v.x)), float(std::rand() % int(v.y))); };
vex4f vex4f::operator%(vex2i v) { return vex4f(float(std::rand() % int(v.x)), float(std::rand() % int(v.y))); };
vex4f vex4f::operator%(vex3f v) { return vex4f(float(std::rand() % int(v.x)), float(std::rand() % int(v.y)), float(std::rand() % int(v.z))); };
vex4f vex4f::operator%(vex3d v) { return vex4f(float(std::rand() % int(v.x)), float(std::rand() % int(v.y)), float(std::rand() % int(v.z))); };
vex4f vex4f::operator%(vex3i v) { return vex4f(float(std::rand() % int(v.x)), float(std::rand() % int(v.y)), float(std::rand() % int(v.z))); };
vex4f vex4f::operator%(vex4f v) { return vex4f(float(std::rand() % int(v.x)), float(std::rand() % int(v.y)), float(std::rand() % int(v.z)), float(std::rand() % int(v.w))); };
vex4f vex4f::operator%(vex4d v) { return vex4f(float(std::rand() % int(v.x)), float(std::rand() % int(v.y)), float(std::rand() % int(v.z)), float(std::rand() % int(v.w))); };
vex4f vex4f::operator%(vex4i v) { return vex4f(float(std::rand() % int(v.x)), float(std::rand() % int(v.y)), float(std::rand() % int(v.z)), float(std::rand() % int(v.w))); };
void vex4f::operator%=(std::string v) { x = float(std::rand() % std::atoi(v.c_str())); y = float(std::rand() % std::atoi(v.c_str())); z = float(std::rand() % std::atoi(v.c_str())); w = float(std::rand() % std::atoi(v.c_str())); };
void vex4f::operator%=(int v) { x = float(std::rand() % v); y = float(std::rand() % v); z = float(std::rand() % v); w = float(std::rand() % v); };
void vex4f::operator%=(float v) { x = float(std::rand() % int(v)); y = float(std::rand() % int(v)); z = float(std::rand() % int(v)); w = float(std::rand() % int(v)); };
void vex4f::operator%=(vex2f v) { x = float(std::rand() % int(v.x)); y = float(std::rand() % int(v.y)); };
void vex4f::operator%=(vex2d v) { x = float(std::rand() % int(v.x)); y = float(std::rand() % int(v.y)); };
void vex4f::operator%=(vex2i v) { x = float(std::rand() % (v.x)); y = float(std::rand() % (v.y)); };
void vex4f::operator%=(vex3f v) { x = float(std::rand() % int(v.x)); y = float(std::rand() % int(v.y)); z = float(std::rand() % int(v.z)); };
void vex4f::operator%=(vex3d v) { x = float(std::rand() % int(v.x)); y = float(std::rand() % int(v.y)); z = float(std::rand() % int(v.z)); };
void vex4f::operator%=(vex3i v) { x = float(std::rand() % (v.x)); y = float(std::rand() % (v.y)); z = float(std::rand() % int(v.z)); };
void vex4f::operator%=(vex4d v) { x = float(std::rand() % int(v.x)); y = float(std::rand() % int(v.y)); z = float(std::rand() % int(v.z)); w = float(std::rand() % int(v.w)); };
void vex4f::operator%=(vex4f v) { x = float(std::rand() % int(v.x)); y = float(std::rand() % int(v.y)); z = float(std::rand() % int(v.z)); w = float(std::rand() % int(v.w)); };
void vex4f::operator%=(vex4i v) { x = float(std::rand() % (v.x)); y = float(std::rand() % (v.y)); z = float(std::rand() % (v.z)); w = float(std::rand() % (v.w)); };
vex4f vex4f::operator|(vex4f v) { return randomb() == 0 ? v : vex4f(x, y, z, w); };
vex4f vex4f::operator|(vex2d v) { return randomb() == 0 ? vex4f(v) : vex4f(x, y, z, w); };
vex4f vex4f::operator|(vex2i v) { return randomb() == 0 ? vex4f(v) : vex4f(x, y, z, w); };
vex4f vex4f::operator|(vex2f v) { return randomb() == 0 ? vex4f(v) : vex4f(x, y, z, w); };
vex4f vex4f::operator|(vex3d v) { return randomb() == 0 ? vex4f(v) : vex4f(x, y, z, w); };
vex4f vex4f::operator|(vex3i v) { return randomb() == 0 ? vex4f(v) : vex4f(x, y, z, w); };
vex4f vex4f::operator|(vex3f v) { return randomb() == 0 ? vex4f(v) : vex4f(x, y, z, w); };
vex4f vex4f::operator|(vex4d v) { return randomb() == 0 ? vex4f(v) : vex4f(x, y, z, w); };
vex4f vex4f::operator|(vex4i v) { return randomb() == 0 ? vex4f(v) : vex4f(x, y, z, w); };
void vex4f::operator|=(vex2f v) { x = randomb() == 0 ? v.x : x;		y = randomb() == 0 ? v.y : y; };
void vex4f::operator|=(vex2d v) { x = randomb() == 0 ? float(v.x) : x; y = randomb() == 0 ? float(v.y) : y; };
void vex4f::operator|=(vex2i v) { x = randomb() == 0 ? float(v.x) : x; y = randomb() == 0 ? float(v.y) : y; };
void vex4f::operator|=(vex3f v) { x = randomb() == 0 ? v.x : x;		y = randomb() == 0 ? v.y : y; z = randomb() == 0 ? v.z : z; };
void vex4f::operator|=(vex3d v) { x = randomb() == 0 ? float(v.x) : x; y = randomb() == 0 ? float(v.y) : y; z = randomb() == 0 ? float(v.z) : z; };
void vex4f::operator|=(vex3i v) { x = randomb() == 0 ? float(v.x) : x; y = randomb() == 0 ? float(v.y) : y; z = randomb() == 0 ? float(v.z) : z; };
void vex4f::operator|=(vex4f v) { x = randomb() == 0 ? v.x : x;		y = randomb() == 0 ? v.y : y;			z = randomb() == 0 ? v.z : z;			w = randomb() == 0 ? v.w : w; };
void vex4f::operator|=(vex4d v) { x = randomb() == 0 ? float(v.x) : x; y = randomb() == 0 ? float(v.y) : y;	z = randomb() == 0 ? float(v.z) : z;	w = randomb() == 0 ? float(v.w) : w; };
void vex4f::operator|=(vex4i v) { x = randomb() == 0 ? float(v.x) : x; y = randomb() == 0 ? float(v.y) : y;	z = randomb() == 0 ? float(v.z) : z;	w = randomb() == 0 ? float(v.w) : w; };

double& vex4d::operator[](int v) { return fmod(v, 4) == 0 ? x : fmod(v, 4) == 1 ? y : fmod(v, 4) == 2 ? z : w; };
double& vex4d::operator[](std::string v) { return fmod(std::atoi(v.c_str()), 4) == 0 ? x : fmod(std::atoi(v.c_str()), 4) == 1 ? y : fmod(std::atoi(v.c_str()), 4) == 2 ? z : w; };
vex4d vex4d::operator!() { return vex4d(w, z, y, x); };
vex4d vex4d::operator%(std::string v) { return vex4d(double(std::rand() % std::atoi(v.c_str())), double(std::rand() % std::atoi(v.c_str())), double(std::rand() % std::atoi(v.c_str()))); };
vex4d vex4d::operator%(int v) { return vex4d(double(std::rand() % v), double(std::rand() % v), double(std::rand() % v), double(std::rand() % v)); };
vex4d vex4d::operator%(double v) { return vex4d(double(std::rand() % int(v)), double(std::rand() % int(v)), double(std::rand() % int(v)), double(std::rand() % int(v))); };
vex4d vex4d::operator%(vex2f v) { return vex4d(double(std::rand() % int(v.x)), double(std::rand() % int(v.y))); };
vex4d vex4d::operator%(vex2d v) { return vex4d(double(std::rand() % int(v.x)), double(std::rand() % int(v.y))); };
vex4d vex4d::operator%(vex2i v) { return vex4d(double(std::rand() % int(v.x)), double(std::rand() % int(v.y))); };
vex4d vex4d::operator%(vex3f v) { return vex4d(double(std::rand() % int(v.x)), double(std::rand() % int(v.y)), double(std::rand() % int(v.z))); };
vex4d vex4d::operator%(vex3d v) { return vex4d(double(std::rand() % int(v.x)), double(std::rand() % int(v.y)), double(std::rand() % int(v.z))); };
vex4d vex4d::operator%(vex3i v) { return vex4d(double(std::rand() % int(v.x)), double(std::rand() % int(v.y)), double(std::rand() % int(v.z))); };
vex4d vex4d::operator%(vex4f v) { return vex4d(double(std::rand() % int(v.x)), double(std::rand() % int(v.y)), double(std::rand() % int(v.z)), double(std::rand() % int(v.w))); };
vex4d vex4d::operator%(vex4d v) { return vex4d(double(std::rand() % int(v.x)), double(std::rand() % int(v.y)), double(std::rand() % int(v.z)), double(std::rand() % int(v.w))); };
vex4d vex4d::operator%(vex4i v) { return vex4d(double(std::rand() % int(v.x)), double(std::rand() % int(v.y)), double(std::rand() % int(v.z)), double(std::rand() % int(v.w))); };
void vex4d::operator%=(std::string v) { x = double(std::rand() % std::atoi(v.c_str())); y = double(std::rand() % std::atoi(v.c_str())); z = double(std::rand() % std::atoi(v.c_str())); w = double(std::rand() % std::atoi(v.c_str())); };
void vex4d::operator%=(int v) { x = double(std::rand() % v); y = double(std::rand() % v); z = double(std::rand() % v); w = double(std::rand() % v); };
void vex4d::operator%=(double v) { x = double(std::rand() % int(v)); y = double(std::rand() % int(v)); z = double(std::rand() % int(v)); w = double(std::rand() % int(v)); };
void vex4d::operator%=(vex2f v) { x = double(std::rand() % int(v.x)); y = double(std::rand() % int(v.y)); };
void vex4d::operator%=(vex2d v) { x = double(std::rand() % int(v.x)); y = double(std::rand() % int(v.y)); };
void vex4d::operator%=(vex2i v) { x = double(std::rand() % (v.x)); y = double(std::rand() % (v.y)); };
void vex4d::operator%=(vex3f v) { x = double(std::rand() % int(v.x)); y = double(std::rand() % int(v.y)); z = double(std::rand() % int(v.z)); };
void vex4d::operator%=(vex3d v) { x = double(std::rand() % int(v.x)); y = double(std::rand() % int(v.y)); z = double(std::rand() % int(v.z)); };
void vex4d::operator%=(vex3i v) { x = double(std::rand() % (v.x)); y = double(std::rand() % (v.y)); z = double(std::rand() % int(v.z)); };
void vex4d::operator%=(vex4d v) { x = double(std::rand() % int(v.x)); y = double(std::rand() % int(v.y)); z = double(std::rand() % int(v.z)); w = double(std::rand() % int(v.w)); };
void vex4d::operator%=(vex4f v) { x = double(std::rand() % int(v.x)); y = double(std::rand() % int(v.y)); z = double(std::rand() % int(v.z)); w = double(std::rand() % int(v.w)); };
void vex4d::operator%=(vex4i v) { x = double(std::rand() % (v.x)); y = double(std::rand() % (v.y)); z = double(std::rand() % (v.z)); w = double(std::rand() % (v.w)); };
vex4d vex4d::operator|(vex4d v) { return randomb() == 0 ? v : vex4d(x, y, z, w); };
vex4d vex4d::operator|(vex2d v) { return randomb() == 0 ? vex4d(v) : vex4d(x, y, z, w); };
vex4d vex4d::operator|(vex2i v) { return randomb() == 0 ? vex4d(v) : vex4d(x, y, z, w); };
vex4d vex4d::operator|(vex2f v) { return randomb() == 0 ? vex4d(v) : vex4d(x, y, z, w); };
vex4d vex4d::operator|(vex3d v) { return randomb() == 0 ? vex4d(v) : vex4d(x, y, z, w); };
vex4d vex4d::operator|(vex3i v) { return randomb() == 0 ? vex4d(v) : vex4d(x, y, z, w); };
vex4d vex4d::operator|(vex3f v) { return randomb() == 0 ? vex4d(v) : vex4d(x, y, z, w); };
vex4d vex4d::operator|(vex4f v) { return randomb() == 0 ? vex4d(v) : vex4d(x, y, z, w); };
vex4d vex4d::operator|(vex4i v) { return randomb() == 0 ? vex4d(v) : vex4d(x, y, z, w); };
void vex4d::operator|=(vex2d v) { x = randomb() == 0 ? v.x : x;		y = randomb() == 0 ? v.y : y; };
void vex4d::operator|=(vex2f v) { x = randomb() == 0 ? double(v.x) : x; y = randomb() == 0 ? double(v.y) : y; };
void vex4d::operator|=(vex2i v) { x = randomb() == 0 ? double(v.x) : x; y = randomb() == 0 ? double(v.y) : y; };
void vex4d::operator|=(vex3d v) { x = randomb() == 0 ? v.x : x;		y = randomb() == 0 ? v.y : y; z = randomb() == 0 ? v.z : z; };
void vex4d::operator|=(vex3f v) { x = randomb() == 0 ? double(v.x) : x; y = randomb() == 0 ? double(v.y) : y; z = randomb() == 0 ? double(v.z) : z; };
void vex4d::operator|=(vex3i v) { x = randomb() == 0 ? double(v.x) : x; y = randomb() == 0 ? double(v.y) : y; z = randomb() == 0 ? double(v.z) : z; };
void vex4d::operator|=(vex4d v) { x = randomb() == 0 ? v.x : x;		y = randomb() == 0 ? v.y : y;			z = randomb() == 0 ? v.z : z;			w = randomb() == 0 ? v.w : w; };
void vex4d::operator|=(vex4f v) { x = randomb() == 0 ? double(v.x) : x; y = randomb() == 0 ? double(v.y) : y;	z = randomb() == 0 ? double(v.z) : z;	w = randomb() == 0 ? double(v.w) : w; };
void vex4d::operator|=(vex4i v) { x = randomb() == 0 ? double(v.x) : x; y = randomb() == 0 ? double(v.y) : y;	z = randomb() == 0 ? double(v.z) : z;	w = randomb() == 0 ? double(v.w) : w; };

int& vex4i::operator[](int v) { return fmod(v, 4) == 0 ? x : fmod(v, 4) == 1 ? y : fmod(v, 4) == 2 ? z : w; };
int& vex4i::operator[](std::string v) { return fmod(std::atoi(v.c_str()), 4) == 0 ? x : fmod(std::atoi(v.c_str()), 4) == 1 ? y : fmod(std::atoi(v.c_str()), 4) == 2 ? z : w; };
vex4i vex4i::operator!() { return vex4i(w, z, y, x); };
vex4i vex4i::operator%(std::string v) { return vex4i(int(std::rand() % std::atoi(v.c_str())), int(std::rand() % std::atoi(v.c_str())), int(std::rand() % std::atoi(v.c_str()))); };
vex4i vex4i::operator%(int v) { return vex4i(int(std::rand() % v), int(std::rand() % v), int(std::rand() % v), int(std::rand() % v)); };
vex4i vex4i::operator%(vex2f v) { return vex4i(int(std::rand() % int(v.x)), int(std::rand() % int(v.y))); };
vex4i vex4i::operator%(vex2d v) { return vex4i(int(std::rand() % int(v.x)), int(std::rand() % int(v.y))); };
vex4i vex4i::operator%(vex2i v) { return vex4i(int(std::rand() % int(v.x)), int(std::rand() % int(v.y))); };
vex4i vex4i::operator%(vex3f v) { return vex4i(int(std::rand() % int(v.x)), int(std::rand() % int(v.y)), int(std::rand() % int(v.z))); };
vex4i vex4i::operator%(vex3d v) { return vex4i(int(std::rand() % int(v.x)), int(std::rand() % int(v.y)), int(std::rand() % int(v.z))); };
vex4i vex4i::operator%(vex3i v) { return vex4i(int(std::rand() % int(v.x)), int(std::rand() % int(v.y)), int(std::rand() % int(v.z))); };
vex4i vex4i::operator%(vex4f v) { return vex4i(int(std::rand() % int(v.x)), int(std::rand() % int(v.y)), int(std::rand() % int(v.z)), int(std::rand() % int(v.w))); };
vex4i vex4i::operator%(vex4d v) { return vex4i(int(std::rand() % int(v.x)), int(std::rand() % int(v.y)), int(std::rand() % int(v.z)), int(std::rand() % int(v.w))); };
vex4i vex4i::operator%(vex4i v) { return vex4i(int(std::rand() % int(v.x)), int(std::rand() % int(v.y)), int(std::rand() % int(v.z)), int(std::rand() % int(v.w))); };
void vex4i::operator%=(std::string v) { x = int(std::rand() % std::atoi(v.c_str())); y = int(std::rand() % std::atoi(v.c_str())); z = int(std::rand() % std::atoi(v.c_str())); w = int(std::rand() % std::atoi(v.c_str())); };
void vex4i::operator%=(int v) { x = int(std::rand() % v); y = int(std::rand() % v); z = int(std::rand() % v); w = int(std::rand() % v); };
void vex4i::operator%=(vex2f v) { x = int(std::rand() % int(v.x)); y = int(std::rand() % int(v.y)); };
void vex4i::operator%=(vex2d v) { x = int(std::rand() % int(v.x)); y = int(std::rand() % int(v.y)); };
void vex4i::operator%=(vex2i v) { x = int(std::rand() % (v.x)); y = int(std::rand() % (v.y)); };
void vex4i::operator%=(vex3f v) { x = int(std::rand() % int(v.x)); y = int(std::rand() % int(v.y)); z = int(std::rand() % int(v.z)); };
void vex4i::operator%=(vex3d v) { x = int(std::rand() % int(v.x)); y = int(std::rand() % int(v.y)); z = int(std::rand() % int(v.z)); };
void vex4i::operator%=(vex3i v) { x = int(std::rand() % (v.x)); y = int(std::rand() % (v.y)); z = int(std::rand() % int(v.z)); };
void vex4i::operator%=(vex4d v) { x = int(std::rand() % int(v.x)); y = int(std::rand() % int(v.y)); z = int(std::rand() % int(v.z)); w = int(std::rand() % int(v.w)); };
void vex4i::operator%=(vex4f v) { x = int(std::rand() % int(v.x)); y = int(std::rand() % int(v.y)); z = int(std::rand() % int(v.z)); w = int(std::rand() % int(v.w)); };
void vex4i::operator%=(vex4i v) { x = int(std::rand() % (v.x)); y = int(std::rand() % (v.y)); z = int(std::rand() % (v.z)); w = int(std::rand() % (v.w)); };
vex4i vex4i::operator|(vex4i v) { return randomb() == 0 ? v : vex4i(x, y, z, w); };
vex4i vex4i::operator|(vex2d v) { return randomb() == 0 ? vex4i(v) : vex4i(x, y, z, w); };
vex4i vex4i::operator|(vex2i v) { return randomb() == 0 ? vex4i(v) : vex4i(x, y, z, w); };
vex4i vex4i::operator|(vex2f v) { return randomb() == 0 ? vex4i(v) : vex4i(x, y, z, w); };
vex4i vex4i::operator|(vex3d v) { return randomb() == 0 ? vex4i(v) : vex4i(x, y, z, w); };
vex4i vex4i::operator|(vex3i v) { return randomb() == 0 ? vex4i(v) : vex4i(x, y, z, w); };
vex4i vex4i::operator|(vex3f v) { return randomb() == 0 ? vex4i(v) : vex4i(x, y, z, w); };
vex4i vex4i::operator|(vex4f v) { return randomb() == 0 ? vex4i(v) : vex4i(x, y, z, w); };
vex4i vex4i::operator|(vex4d v) { return randomb() == 0 ? vex4i(v) : vex4i(x, y, z, w); };
void vex4i::operator|=(vex2i v) { x = randomb() == 0 ? v.x : x;		y = randomb() == 0 ? v.y : y; };
void vex4i::operator|=(vex2f v) { x = randomb() == 0 ? int(v.x) : x;	y = randomb() == 0 ? int(v.y) : y; };
void vex4i::operator|=(vex2d v) { x = randomb() == 0 ? int(v.x) : x;	y = randomb() == 0 ? int(v.y) : y; };
void vex4i::operator|=(vex3i v) { x = randomb() == 0 ? v.x : x;		y = randomb() == 0 ? v.y : y;		z = randomb() == 0 ? v.z : z; };
void vex4i::operator|=(vex3f v) { x = randomb() == 0 ? int(v.x) : x;	y = randomb() == 0 ? int(v.y) : y;	z = randomb() == 0 ? int(v.z) : z; };
void vex4i::operator|=(vex3d v) { x = randomb() == 0 ? int(v.x) : x;	y = randomb() == 0 ? int(v.y) : y;	z = randomb() == 0 ? int(v.z) : z; };
void vex4i::operator|=(vex4i v) { x = randomb() == 0 ? v.x : x;		y = randomb() == 0 ? v.y : y;		z = randomb() == 0 ? v.z : z;		w = randomb() == 0 ? v.w : w; };
void vex4i::operator|=(vex4f v) { x = randomb() == 0 ? int(v.x) : x;	y = randomb() == 0 ? int(v.y) : y;	z = randomb() == 0 ? int(v.z) : z;	w = randomb() == 0 ? int(v.w) : w; };
void vex4i::operator|=(vex4d v) { x = randomb() == 0 ? int(v.x) : x;	y = randomb() == 0 ? int(v.y) : y;	z = randomb() == 0 ? int(v.z) : z;	w = randomb() == 0 ? int(v.w) : w; };

vex2b::vex2b(int& v1, int& v2) { x = v1 % 2 ? false : true; y = v2 % 2 ? false : true; };
vex2b::vex2b(int& v1) { x = v1 % 2 ? false : true; y = v1 % 2 ? false : true; };
vex2b::vex2b(vex3b v1) { x = v1.x; y = v1.y; };
vex2b::vex2b(vex4b v1) { x = v1.x; y = v1.y; };
bool vex2b::operator==(bool v) { return x == v && y == v; };
bool vex2b::operator==(vex3b v) { return x == v.x && y == v.y; };
bool vex2b::operator==(vex4b v) { return x == v.x && y == v.y; };
bool vex2b::operator!=(bool v) { return x != v && y != v; };
bool vex2b::operator!=(vex2b v) { return x != v.x && y != v.y; };
bool vex2b::operator!=(vex3b v) { return x != v.x && y != v.y; };
bool vex2b::operator!=(vex4b v) { return x != v.x && y != v.y; };
void vex2b::operator|=(bool v) { x = randomb() ? v : x; y = randomb() ? v : y; };
void vex2b::operator|=(vex2b v) { x = randomb() ? v.x : x; y = randomb() ? v.y : y; };
void vex2b::operator|=(vex3b v) { x = randomb() ? v.x : x; y = randomb() ? v.y : y; };
void vex2b::operator|=(vex4b v) { x = randomb() ? v.x : x; y = randomb() ? v.y : y; };
vex2b vex2b::operator!() { return vex2b(y, x); };
bool vex2b::operator[](int v) { return v % 2 ? y : x; };
bool vex2b::operator[](size_t& v) { return v % 2 ? y : x; };

void vex2f::operator()(vex2f& v) { const vex2f _t = v; v = *this; *this = _t; };
void vex2f::operator()(vex2d& v) { const vex2d _t = v; v = *this; *this = _t; };
void vex2f::operator()(vex2i& v) { const vex2i _t = v; v = *this; *this = _t; };
void vex2f::operator()(vex3f& v) { const vex3f _t = v; v = *this; *this = _t; };
void vex2f::operator()(vex3d& v) { const vex3d _t = v; v = *this; *this = _t; };
void vex2f::operator()(vex3i& v) { const vex3i _t = v; v = *this; *this = _t; };
void vex2f::operator()(vex4f& v) { const vex4f _t = v; v = *this; *this = _t; };
void vex2f::operator()(vex4d& v) { const vex4d _t = v; v = *this; *this = _t; };
void vex2f::operator()(vex4i& v) { const vex4i _t = v; v = *this; *this = _t; };

void vex2d::operator()(vex2f& v) { const vex2f _t = v; v = *this; *this = _t; };
void vex2d::operator()(vex2d& v) { const vex2d _t = v; v = *this; *this = _t; };
void vex2d::operator()(vex2i& v) { const vex2i _t = v; v = *this; *this = _t; };
void vex2d::operator()(vex3f& v) { const vex3f _t = v; v = *this; *this = _t; };
void vex2d::operator()(vex3d& v) { const vex3d _t = v; v = *this; *this = _t; };
void vex2d::operator()(vex3i& v) { const vex3i _t = v; v = *this; *this = _t; };
void vex2d::operator()(vex4f& v) { const vex4f _t = v; v = *this; *this = _t; };
void vex2d::operator()(vex4d& v) { const vex4d _t = v; v = *this; *this = _t; };
void vex2d::operator()(vex4i& v) { const vex4i _t = v; v = *this; *this = _t; };

void vex2i::operator()(vex2f& v) { const vex2f _t = v; v = *this; *this = _t; };
void vex2i::operator()(vex2d& v) { const vex2d _t = v; v = *this; *this = _t; };
void vex2i::operator()(vex2i& v) { const vex2i _t = v; v = *this; *this = _t; };
void vex2i::operator()(vex3f& v) { const vex3f _t = v; v = *this; *this = _t; };
void vex2i::operator()(vex3d& v) { const vex3d _t = v; v = *this; *this = _t; };
void vex2i::operator()(vex3i& v) { const vex3i _t = v; v = *this; *this = _t; };
void vex2i::operator()(vex4f& v) { const vex4f _t = v; v = *this; *this = _t; };
void vex2i::operator()(vex4d& v) { const vex4d _t = v; v = *this; *this = _t; };
void vex2i::operator()(vex4i& v) { const vex4i _t = v; v = *this; *this = _t; };

void vex3f::operator()(vex2f& v) { const vex2f _t = v; v = *this; *this = _t; };
void vex3f::operator()(vex2d& v) { const vex2d _t = v; v = *this; *this = _t; };
void vex3f::operator()(vex2i& v) { const vex2i _t = v; v = *this; *this = _t; };
void vex3f::operator()(vex3f& v) { const vex3f _t = v; v = *this; *this = _t; };
void vex3f::operator()(vex3d& v) { const vex3d _t = v; v = *this; *this = _t; };
void vex3f::operator()(vex3i& v) { const vex3i _t = v; v = *this; *this = _t; };
void vex3f::operator()(vex4f& v) { const vex4f _t = v; v = *this; *this = _t; };
void vex3f::operator()(vex4d& v) { const vex4d _t = v; v = *this; *this = _t; };
void vex3f::operator()(vex4i& v) { const vex4i _t = v; v = *this; *this = _t; };

void vex3d::operator()(vex2f& v) { const vex2f _t = v; v = *this; *this = _t; };
void vex3d::operator()(vex2d& v) { const vex2d _t = v; v = *this; *this = _t; };
void vex3d::operator()(vex2i& v) { const vex2i _t = v; v = *this; *this = _t; };
void vex3d::operator()(vex3f& v) { const vex3f _t = v; v = *this; *this = _t; };
void vex3d::operator()(vex3d& v) { const vex3d _t = v; v = *this; *this = _t; };
void vex3d::operator()(vex3i& v) { const vex3i _t = v; v = *this; *this = _t; };
void vex3d::operator()(vex4f& v) { const vex4f _t = v; v = *this; *this = _t; };
void vex3d::operator()(vex4d& v) { const vex4d _t = v; v = *this; *this = _t; };
void vex3d::operator()(vex4i& v) { const vex4i _t = v; v = *this; *this = _t; };

void vex3i::operator()(vex2f& v) { const vex2f _t = v; v = *this; *this = _t; };
void vex3i::operator()(vex2d& v) { const vex2d _t = v; v = *this; *this = _t; };
void vex3i::operator()(vex2i& v) { const vex2i _t = v; v = *this; *this = _t; };
void vex3i::operator()(vex3f& v) { const vex3f _t = v; v = *this; *this = _t; };
void vex3i::operator()(vex3d& v) { const vex3d _t = v; v = *this; *this = _t; };
void vex3i::operator()(vex3i& v) { const vex3i _t = v; v = *this; *this = _t; };
void vex3i::operator()(vex4f& v) { const vex4f _t = v; v = *this; *this = _t; };
void vex3i::operator()(vex4d& v) { const vex4d _t = v; v = *this; *this = _t; };
void vex3i::operator()(vex4i& v) { const vex4i _t = v; v = *this; *this = _t; };

void vex4f::operator()(vex2f& v) { const vex2f _t = v; v = *this; *this = _t; };
void vex4f::operator()(vex2d& v) { const vex2d _t = v; v = *this; *this = _t; };
void vex4f::operator()(vex2i& v) { const vex2i _t = v; v = *this; *this = _t; };
void vex4f::operator()(vex3f& v) { const vex3f _t = v; v = *this; *this = _t; };
void vex4f::operator()(vex3d& v) { const vex3d _t = v; v = *this; *this = _t; };
void vex4f::operator()(vex3i& v) { const vex3i _t = v; v = *this; *this = _t; };
void vex4f::operator()(vex4f& v) { const vex4f _t = v; v = *this; *this = _t; };
void vex4f::operator()(vex4d& v) { const vex4d _t = v; v = *this; *this = _t; };
void vex4f::operator()(vex4i& v) { const vex4i _t = v; v = *this; *this = _t; };

void vex4d::operator()(vex2f& v) { const vex2f _t = v; v = *this; *this = _t; };
void vex4d::operator()(vex2d& v) { const vex2d _t = v; v = *this; *this = _t; };
void vex4d::operator()(vex2i& v) { const vex2i _t = v; v = *this; *this = _t; };
void vex4d::operator()(vex3f& v) { const vex3f _t = v; v = *this; *this = _t; };
void vex4d::operator()(vex3d& v) { const vex3d _t = v; v = *this; *this = _t; };
void vex4d::operator()(vex3i& v) { const vex3i _t = v; v = *this; *this = _t; };
void vex4d::operator()(vex4f& v) { const vex4f _t = v; v = *this; *this = _t; };
void vex4d::operator()(vex4d& v) { const vex4d _t = v; v = *this; *this = _t; };
void vex4d::operator()(vex4i& v) { const vex4i _t = v; v = *this; *this = _t; };

void vex4i::operator()(vex2f& v) { const vex2f _t = v; v = *this; *this = _t; };
void vex4i::operator()(vex2d& v) { const vex2d _t = v; v = *this; *this = _t; };
void vex4i::operator()(vex2i& v) { const vex2i _t = v; v = *this; *this = _t; };
void vex4i::operator()(vex3f& v) { const vex3f _t = v; v = *this; *this = _t; };
void vex4i::operator()(vex3d& v) { const vex3d _t = v; v = *this; *this = _t; };
void vex4i::operator()(vex3i& v) { const vex3i _t = v; v = *this; *this = _t; };
void vex4i::operator()(vex4f& v) { const vex4f _t = v; v = *this; *this = _t; };
void vex4i::operator()(vex4d& v) { const vex4d _t = v; v = *this; *this = _t; };
void vex4i::operator()(vex4i& v) { const vex4i _t = v; v = *this; *this = _t; };
...
void XsPrinter::operator<<(std::vector<int> _v) { for (int _i = 0; _i < _v.size(); _i++) std::cout << _v[_i] << _between; };
void XsPrinter::operator<<(std::vector<float> _v) { for (int _i = 0; _i < _v.size(); _i++) std::cout << _v[_i] << _between; };
void XsPrinter::operator<<(std::vector<double> _v) { for (int _i = 0; _i < _v.size(); _i++) std::cout << _v[_i] << _between; };
void XsPrinter::operator<<(std::vector<char> _v) { for (int _i = 0; _i < _v.size(); _i++) std::cout << _v[_i] << _between; };
void XsPrinter::operator<<(std::vector<std::string> _v) { for (int _i = 0; _i < _v.size(); _i++) std::cout << _v[_i] << _between; };
...
void XsPrinter::operator<<(vex2f _v) { std::cout << _v.x << _between << _v.y << _between; };
void XsPrinter::operator<<(vex2d _v) { std::cout << _v.x << _between << _v.y << _between; };
void XsPrinter::operator<<(vex2i _v) { std::cout << _v.x << _between << _v.y << _between; };
void XsPrinter::operator<<(vex2h _v) { std::cout << _v.x << _between << _v.y << _between; };
void XsPrinter::operator<<(vex2s _v) { std::cout << _v.x << _between << _v.y << _between; };
void XsPrinter::operator<<(vex2b _v) { std::cout << _v.x << _between << _v.y << _between; };
void XsPrinter::operator<<(vex3f _v) { std::cout << _v.x << _between << _v.y << _between << _v.z << _between; };
void XsPrinter::operator<<(vex3d _v) { std::cout << _v.x << _between << _v.y << _between << _v.z << _between; };
void XsPrinter::operator<<(vex3i _v) { std::cout << _v.x << _between << _v.y << _between << _v.z << _between; };
void XsPrinter::operator<<(vex3h _v) { std::cout << _v.x << _between << _v.y << _between << _v.z << _between; };
void XsPrinter::operator<<(vex3s _v) { std::cout << _v.x << _between << _v.y << _between << _v.z << _between; };
void XsPrinter::operator<<(vex3b _v) { std::cout << _v.x << _between << _v.y << _between << _v.z << _between; };
void XsPrinter::operator<<(vex4f _v) { std::cout << _v.x << _between << _v.y << _between << _v.z << _between << _v.w << _between; };
void XsPrinter::operator<<(vex4d _v) { std::cout << _v.x << _between << _v.y << _between << _v.z << _between << _v.w << _between; };
void XsPrinter::operator<<(vex4i _v) { std::cout << _v.x << _between << _v.y << _between << _v.z << _between << _v.w << _between; };
void XsPrinter::operator<<(vex4h _v) { std::cout << _v.x << _between << _v.y << _between << _v.z << _between << _v.w << _between; };
void XsPrinter::operator<<(vex4s _v) { std::cout << _v.x << _between << _v.y << _between << _v.z << _between << _v.w << _between; };
void XsPrinter::operator<<(vex4b _v) { std::cout << _v.x << _between << _v.y << _between << _v.z << _between << _v.w << _between; };